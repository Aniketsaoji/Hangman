...
public class HangmanClientWordGuesser {
	...
	public static void player2Stuff(InetAddress MCIP, int pn) throws IOException {
		for (int i = 0; i<6; i++) {
			Scanner in = new Scanner(System.in);
			String guess = in.nextLine();
			sendMulticast(MCIP, pn, guess);
			receiveMulticast();
		}
